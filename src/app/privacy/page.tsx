...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-background relative overflow-hidden flex items-center justify-center py-20">
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10 mt-24">
        <Link 
          href="/" 
          className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors group mb-12"
        >
        ...
        <div className="text-lg text-muted-foreground leading-relaxed glass p-8 md:p-12 rounded-3xl border border-white/5 shadow-2xl">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-foreground mb-4">No Data Collection</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-foreground mb-4">No Cookies</h2>
            <p>
